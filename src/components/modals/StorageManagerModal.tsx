            ...
            <div className="p-6">
                ...
                <div className="mt-6">
                    <div className="bg-slate-800/50 p-1 rounded-xl flex border border-slate-700">
                        ...
                        <TabButton tab="external">Export &amp; Import</TabButton>
                    </div>
                    <div className="mt-4 p-4 bg-slate-900/40 rounded-lg min-h-[150px]">
                        {activeTab === 'internal' ? (
                            ...
                            <div className="animate-fade-in space-y-3" style={{animationDuration: '300ms'}}>
                                <h4 className="font-semibold text-white mb-2">Export &amp; Import Data</h4>
                                <p className="text-sm text-gray-400 mb-4">
                                    Export your data for safekeeping, or restore from a previously saved backup file.
                                </p>
                                <button
                                    onClick={onExport}
