...
export const FacebookIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="currentColor" {...props}>
        <path d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 4.84 3.44 8.87 8 9.8V15H8v-3h2V9.5C10 7.57 11.57 6 13.5 6H16v3h-1.5c-.84 0-1 .16-1 .82V12h2.5l-.5 3H15v6.8c4.56-.93 8-4.96 8-9.8z" />
    </svg>
);
...
export const SparklesIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M12 3a6.5 6.5 0 0 0-6.5 6.5c0 1.68.62 3.2 1.66 4.34L2 22l6.83-3.04A6.5 6.5 0 0 0 12 19.5a6.5 6.5 0 0 0 6.5-6.5A6.5 6.5 0 0 0 12 3Z"></path>
        <path d="M17 3v4"></path><path d="M21 5h-4"></path>
    </svg>
);
...
export const SyncIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <path d="M3 3v5h5"></path><path d="M3 12a9 9 0 0 0 9 9 9.75 9.75 0 0 0 6.74-2.74L21 16"></path>
        <path d="M21 21v-5h-5"></path>
    </svg>
);

export const ThermometerIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const DropletsIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M7 16.3c2.2 0 4-1.83 4-4.05 0-1.16-.48-2.26-1.3-3.05a4.01 4.01 0 0 0-5.4-1.42A4.01 4.01 0 0 0 3 12.25C3 14.47 4.8 16.3 7 16.3z"></path>
    <path d="M12.56 6.6A10.97 10.97 0 0 0 14 3.02c.52 1.28 1.47 2.24 2.5 2.81A10.97 10.97 0 0 0 17.98 9c-.52-1.28-1.47-2.24-2.5-2.81a10.97 10.97 0 0 0-1.02-2.58"></path>
  </svg>
);

export const TestTubeIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M14.5 2v17.5c0 1.38-1.12 2.5-2.5 2.5h0c-1.38 0-2.5-1.12-2.5-2.5V2"></path>
        <path d="M8.5 2a2.5 2.5 0 0 1 5 0v0"></path><path d="M14.5 16h-5"></path>
    </svg>
);
...
export const VirusIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <circle cx="12" cy="12" r="10"></circle><path d="M12 2a4.5 4.5 0 0 0-4.5 4.5v0"></path>
        <path d="M12 22a4.5 4.5 0 0 0 4.5-4.5v0"></path><path d="M22 12a4.5 4.5 0 0 0-4.5-4.5h0"></path>
        <path d="M2 12a4.5 4.5 0 0 0 4.5 4.5h0"></path><path d="M12 7v10"></path><path d="M7 12h10"></path>
    </svg>
);
...
export const AquaLogoIcon: React.FC<IconProps> = (props) => (
    <svg width="24" height="24" viewBox="0 0 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        <path d="M12 2.69C12 2.69 6.34 8.35 6.34 13.41C6.34 17.57 9.08 20.9 12 20.9C14.92 20.9 17.66 17.57 17.66 13.41C17.66 8.35 12 2.69 12 2.69Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M12 10.5C13.6569 10.5 15 9.15685 15 7.5" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
    </svg>
);
...
export const StomachIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <path d="M8 12a4 4 0 0 1 4-4 4 4 0 0 1 4 4c0 2.5-4 6-4 6s-4-3.5-4-6Z"></path>
        <path d="M10 10c0-1.1.9-2 2-2s2 .9 2 2"></path>
    </svg>
);

export const HeadacheIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M12 2a10 10 0 1 0 10 10c0-1.8-.5-3.5-1.4-5" />
        <path d="m15.1 8.9-2.2 2.2" />
        <path d="M12.9 11.1 15.1 8.9" />
        <path d="M10 16H8" />
        <path d="M16 16h-2" />
        <path d="M12 2v2.5" />
...
export const MemoryStickIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <path d="M12 11V9"/>
        <path d="M2 15h20"/>
        <path d="M2 7a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v1.1a2 2 0 0 0 0 3.837V15a2 2 0 0 1-2-2H4a2 2 0 0 1-2-2v-2.1a2 2 0 0 0 0-3.837Z"/>
    </svg>
);
...
export const BatteryChargingIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <polyline points="11.5 7 13 12 9.5 12 8 17"/>
    </svg>
);
...
export const EjectIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M5 17h14v2H5v-2zM12 5l7 7H5l7-7z"/>
    </svg>
);
...
export const RadarIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M12 12a10 10 0 1 0-10-10 10 10 0 0 0 10 10z"/>
        <path d="M12 12a6 6 0 1 0-6-6 6 6 0 0 0 6 6z"/>
