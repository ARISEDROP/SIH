...
import { BluetoothIcon, SyncIcon, CheckCircleIcon, BluetoothOffIcon, AlertTriangleIcon, RadarIcon, EjectIcon } from './icons';
import { TestTubeIcon, DropletsIcon, ThermometerIcon } from './icons';
