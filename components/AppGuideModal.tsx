...
// FIX: Role type should be imported from constants where it is defined.
import { Role } from '../constants';
import { UserIcon, UserGroupIcon, ScannerIcon, PlusIcon, MapIcon, BookOpenIcon, SparklesIcon, RadarIcon, InfoIcon } from './icons';
